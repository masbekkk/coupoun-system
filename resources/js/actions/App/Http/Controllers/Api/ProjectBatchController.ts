...
/**
* @see \App\Http\Controllers\Api\ProjectBatchController::index
* @see app/Http/Controllers/Api/ProjectBatchController.php:13
* @route '/api/v1/projects/{project}/batches'
*/
...
index.definition = {
    methods: ["get","head"],
    url: '/api/v1/projects/{project}/batches',
...
const ProjectBatchController = { index }

export default ProjectBatchController