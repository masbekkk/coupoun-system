...
/**
* @see \App\Http\Controllers\UserEmailVerificationController::update
...
const UserEmailVerificationController = { update }

export default UserEmailVerificationController