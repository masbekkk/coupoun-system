...
import { i as DialogDescription, o as DialogHeader, r as DialogContent, s as DialogTitle, t as Dialog } from "./dialog-ChxCstgp.js";
import { a as regenerateRecoveryCodes, c as InputOTP, i as enable, l as InputOTPGroup, n as confirm, o as show, r as disable, t as useTwoFactorAuth, u as InputOTPSlot } from "./use-two-factor-auth-CR2Txqsa.js";
...
//#endregion
//#region resources/js/pages/user-two-factor-authentication/show.tsx
var breadcrumbs = [{
	title: "Two-Factor Authentication",
	href: show()
}];
function TwoFactor({ canManageTwoFactor = false, requiresConfirmation = false, twoFactorEnabled = false }) {
	...
	return /* @__PURE__ */ jsxs(app_layout_default, {
		breadcrumbs,
		children: [/* @__PURE__ */ jsx(Head, { title: "Two-Factor Authentication" }), /* @__PURE__ */ jsx(SettingsLayout, { children: canManageTwoFactor && /* @__PURE__ */ jsxs("div", {
			className: "space-y-6",
			children: [
